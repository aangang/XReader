package com.android.xreader.views;
...
public class CountDownView extends View {
    ...
    public CountDownView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mRingColor = a.getColor(R.styleable.CountDownView_ringColor, 0x6600ff00);
        mRingWidth = a.getFloat(R.styleable.CountDownView_ringWidth, 6);
        mRingProgessTextSize = a.getDimensionPixelSize(R.styleable.CountDownView_progressTextSize, 35);
        mProgessTextColor = a.getColor(R.styleable.CountDownView_progressTextColor, 0x880000ff);
    ...
    public void startCountDown() {
        setClickable(false);
        ValueAnimator valueAnimator = getValA(mCountdownTime * 60 * 1000);
